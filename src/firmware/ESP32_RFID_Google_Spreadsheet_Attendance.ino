...
const char* ssid = "Ahban";  //--> Wifi name
const char* password = "Ahban0808"; //--> Wifi password
//----------------------------------------

// Google script Web_App_URL.
String Web_App_URL = "https://script.google.com/macros/s/AKfycbwGi_K0oOn4lfJ0vwEcXTJDHAhcqv89LqGmP_DBH6P2QU4Zpvga2Sf8KwOmTXTe3x9raQ/exec";
