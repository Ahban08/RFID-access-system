// Reference: "How to Use MFRC-522 with ESP32" - YouTube
// https://www.youtube.com/watch?v=r0Ndu2VYR2Y&t=3s
// Used for implementation of RFID with ESP32.
...
function doGet(e) { 
  ...
  if (e.parameter == 'undefined') {
    ...
    var sheet_id = '1uknPqSkV3DES9gepRBl3lRd545sgpA_HfiGNgsrDKNw'; 	// Spreadsheet ID.
